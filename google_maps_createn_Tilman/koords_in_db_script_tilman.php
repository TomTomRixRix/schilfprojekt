...
$deletequery = "DELETE Koordinaten WHERE Name LIKE 'tilman%'";
$deleteresult = mysql_query($deletequery);
			    if (!$deleteresult) {die('Invalid deletequery: ' . mysql_error());
			    
// -----in .xml konvertierte .gpx-datei, in "UTF-8 with BOM" konvertieren(!) 
$xmlurl = "http://tms-hl.de/inf1213/12/schilf/Homepage_schilf/google_maps_createn_Tilman/2013-10-23_Tilman_WakenitzSW_mitbildlinksundpflanze.xml";
// $xmlurl = "http://tms-hl.de/inf1213/12/schilf/Homepage_schilf/google_maps_createn_Tilman/2013-10-23_Mara_WakenitzSO_mitbildlinksundpflanze.xml";
    ...
    foreach ($xml -> rte[$i-1] -> rtept as $point){
        ...
        if ($lastlat != $lat or $lastlon != $lon) { // wenn die koordinate neu ist
            ...
            // } elseif (koordinaten wie bei kl see, wakenitz brücke, gr sarau...) {
                ...
                $name = "tilman".$i; // ------------------------------------------- an aufzeichner/ung anpassen (wird name der polyline)
            }
