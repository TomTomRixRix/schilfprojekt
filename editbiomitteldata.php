<!--Auf dieser Seite kann der Admin die Mittelwerte der gemessenen biologischen Parameter bearbeiten. Dies ist natürlich passwortgeschützt. Standort und Datum wurden über die URL übergeben.-->
<?php
...
<div id="editchemdata">
	<?php
		...
		//Datenbankanfrage: Liefer' alle biologischen Mittelwerte von dem Standort und Datum
        ...
        while ( $zeile = mysql_fetch_assoc($ergebnis) ) {
			echo('			
				<form name="dateneingabe" action="?site=editbiomitteldata&ort='.$StandortID.'&date='.$DatumID.'" method="post">
		...
		//Genauso wie beim erstmaligen eingeben der Daten bei "inputbiomitteldata". 
        if ( isset($_POST['speichern']) ) {
				...
				if($Standort=="Gross Sarau"){
					...
					include('datenbank.php');
					$anfrage = 'UPDATE biologischeMittelwerte 
